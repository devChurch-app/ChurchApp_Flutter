    ...
    return Scaffold(
      ...
      floatingActionButton: AnimatedOpacity(
        child: FloatingActionButton.extended(
          ...
          onPressed: () {
            Navigator.of(context).pushNamed(NoteEditorScreen.routeName);
          },
                ...
                InkWell(
                  ...
                  onTap: () async {
                    await FlutterShare.share(
                        title: object.title,
                        text: NotusDocument.fromJson(jsonDecode(object.content))
                            .toPlainText());
                  },
                ),
                Container(width: 15),
                InkWell(
                  ...
                  onTap: () {
                    FlutterClipboard.copy(
                            NotusDocument.fromJson(jsonDecode(object.content))
                                .toPlainText())
                        .then((value) =>
