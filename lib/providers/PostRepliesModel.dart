...
class PostRepliesModel with ChangeNotifier {
  ...
  Future<void> fetchComments() async {
    try {
      final response = await http.post(ApiUrl.loadpostreplies,
          body: jsonEncode({
  ...
  Future<void> constructComment(String content) async {
    try {
      ...
      print(data.toString());
      final response = await http.post(ApiUrl.replypostcomment,
  ...
  Future<void> deleteComment(int commentId, int position) async {
    ...
    try {
      ...
      print(data.toString());
      final response = await http.post(ApiUrl.deletepostreply,
          body: jsonEncode({"data": data}));
      if (response.statusCode == 200) {
        // If the server did return a 200 OK response,
        // then parse the JSON.
  ...
  Future<void> editComment(int id, String content, int position) async {
    ...
    try {
      ...
      print(data.toString());
      final response = await http.post(ApiUrl.editpostreply,
          body: jsonEncode({"data": data}));
      if (response.statusCode == 200) {
        // If the server did return a 200 OK response,
        // then parse the JSON.
